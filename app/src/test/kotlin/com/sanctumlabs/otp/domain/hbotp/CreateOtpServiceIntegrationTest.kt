package com.sanctumlabs.otp.domain.hbotp
...
class CreateOtpServiceIntegrationTest : BaseIntegrationTest(), KoinTest {
    ...
    private val hmacBasedOtpCodeGenConfig = HmacCodeGeneratorConfig(
    ...
    val koinTestExtension = KoinTestExtension.create {
        modules(
            module {
                ...
                single<OtpCodeGenerator> { HmacBasedCodeGenerator(key, hmacBasedOtpCodeGenConfig) }
