...
![our architecture](images/our-architecture.png)
![uncle bob's architecture](images/uncle-bobs-architecture.png)

##### Core: Entities
* Represent your domain object
* Apply only logic that is applicable in general to the whole entity (e.g. validating the format of an hostname)
* Plain kotlin objects: no frameworks, no annotations

##### Core: Use Cases
* Represent your business actions, it’s what you can do with the application. Expect one use case for each business action
* Pure business logic, plain kotlin (expect maybe some utils libraries)
